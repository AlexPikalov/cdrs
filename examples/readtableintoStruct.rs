...
///
/// ```
///CREATE KEYSPACE my_namespace WITH REPLICATION = { 'class' : 'SimpleStrategy', 'replication_factor' : 1 };
...
/// INSERT INTO emp (emp_id, emp_name, emp_city,emp_phone, emp_sal) VALUES(1,'alex', 'NJ', 9848022338, 50000)
/// INSERT INTO emp (emp_id, emp_name, emp_city,emp_phone, emp_sal) VALUES(2,'harry', 'FLL', 9848022338, 50000)
///
/// 
/// ```
