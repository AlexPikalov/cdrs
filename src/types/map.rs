...
map_as_rust!({ Vec<u8> }, { Vec<u8> });
map_as_rust!({ Vec<u8> }, { String });
map_as_rust!({ Vec<u8> }, { bool });
map_as_rust!({ Vec<u8> }, { i64 });
map_as_rust!({ Vec<u8> }, { i32 });
map_as_rust!({ Vec<u8> }, { i16 });
map_as_rust!({ Vec<u8> }, { i8 });
map_as_rust!({ Vec<u8> }, { f64 });
map_as_rust!({ Vec<u8> }, { f32 });
map_as_rust!({ Vec<u8> }, { IpAddr });
map_as_rust!({ Vec<u8> }, { Uuid });
map_as_rust!({ Vec<u8> }, { Timespec });
map_as_rust!({ Vec<u8> }, { List });
map_as_rust!({ Vec<u8> }, { Map });
map_as_rust!({ Vec<u8> }, { UDT });
map_as_rust!({ Vec<u8> }, { Tuple });

map_as_rust!({ String }, { Vec<u8> });
